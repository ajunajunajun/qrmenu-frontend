      ...
      <div className="u-mypage-div">
        <div className="u-mypage-div-box">
          <div className="u-mypage-div-box-name">
            <p className="u-mypage-div-box-name-text">{data.name}<br/>{data.id}</p>
          </div>
          <ul className="u-mypage-div-box-list">
            ...
            <li className="u-mypage-div-box-list-item">
            <Link to="#" className="u-mypage-link">
             <p className="u-mypage-div-box-list-item-text">プロフィール編集</p> 
            </Link>
            </li>
            <li className="u-mypage-div-box-list-item">
              <Link to="#" className="u-mypage-link">
              <p className="u-mypage-div-box-list-item-text">アカウント情報</p> 
              </Link>
            </li>
            <li className="u-mypage-div-box-list-item">
              <Link to="#" className="u-mypage-link">
              <p className="u-mypage-div-box-list-item-text">パスワード変更</p> 
              </Link>
            </li>
            <li className="u-mypage-div-box-list-item">
              <Link to="#" className="u-mypage-link">
            ...
            <li className="u-mypage-div-box-list-item">
              <Link to="#" className="u-mypage-link">
              <p className="u-mypage-div-box-list-item-text">号座情報の登録</p> 
              </Link>
            </li>
            <li className="u-mypage-div-box-list-item">
              <Link to="#" className="u-mypage-link">
        ...
        <div className="u-mypage-div3">
          ...
          <Link to="/createmenu" className="u-mypage-link">
            <div className="u-mypage-div3-box">
              <img src= {img1} alt="メニュー画像1" className="u-mypage-div3-box-img"/>
              <p className="u-mypage-div3-box-text">通常メニュー</p>
            </div>
          </Link>
          <Link to="/createmenu" className="u-mypage-link">
            <div className="u-mypage-div3-box2">
            <img src= {img2} alt="メニュー画像2" className="u-mypage-div3-box2-img"/>
