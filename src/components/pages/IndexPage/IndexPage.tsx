    ...
    <div className="u-inner">
      <div className="u-indexpage-div">
        <div className="u-indexpage-div-box">
          <img src={orange} alt="オレンジの背景" className="u-indexpage-div-box-img"/>
      ...
      <div className="u-indexpage-div3">
          ...
          <img src={img4} alt="" className="u-indexpage-div3-box3-img"/>
           <p className="u-indexpage-div3-text2">簡単にメニュー作成</p>
            <p className="u-indexpage-div3-text3">Web上でテンプレートを利用しメニュー作りをサポート！デザインにももう困らず、今までよりも作成時間を短縮できる！</p>
          </div>
      </div>

      <div className="u-indexpage-div4">
        <p　 className="u-indexpage-div4-text">CroUの仕組み</p>
        <p className="u-indexpage-div4-text1">お客様は各席ごとの二次元バーコードを読み取ることで<br/>スマートフォンから注文できるようになります。<br/>テーブルの管理はスタッフ専用アプリで、注文が入るとプリンターから出力されます。</p>
        ...
        <div className="u-indexpage-div4-box">
            ...
            <p className="u-indexpage-div4-text3">スタッフ専用アプリでお店全体の座席を管理します。簡単操作でお客様の注文履歴の確認・変更、食べ飲み放題の管理をおこないます。</p>
        </div>
        <div className="u-indexpage-div4-box1">
            <p className="u-indexpage-div4-text2">お客様</p>
            <p className="u-indexpage-div4-text3">スマートフォンで注文専用の二次元バーコードを読み取って注文ページにアクセスします。会員登録などは不要。どんなお客様でもすぐに注文を始めることができます。</p>
        </div>
        <div className="u-indexpage-div4-box2">
            <p className="u-indexpage-div4-text2">キッチンスタッフ</p>
            <p className="u-indexpage-div4-text3">調理場ではプリンタから出力された調理伝票を見て調理します。伝票はメニューごとにプリンタを出し分けることも可能です。</p>
        </div>
      </div>
